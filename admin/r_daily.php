                                    ...
                                    <div class="col-md-12">
                                        <div class="card mt-5">
                                            <div class="card-header">
                                                <h3 style="font-family: kanit;">ข้อมูลรายได้ต่อวันของร้าน</h3>
                                            </div>
                                            <br />
                                            <div class="card-body">
                                        ...
                                        <div class="card mt-4">
                                            <div class="card-body">
                                                <table class="table table-borderd">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center" style="width: 60%;">วัน/เดือน/ปี
                                                            </th>
                                                            <th class="text-center" style="width: 40%;">จำนวนเงิน</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        ...
                                                        if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                                                            ...
                                                            $query = "SELECT o_total, SUM(o_total) AS totol, DATE_FORMAT(o_dttm, '%d %M %Y') AS o_dttm
                                    FROM order_head WHERE o_dttm BETWEEN '$from_date' AND '$to_date'
                                    GROUP BY DATE_FORMAT(o_dttm, '%d%')
                                    ORDER BY DATE_FORMAT(o_dttm, '%Y-%m-%d') ASC
                                        ";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td <td align="right" style="padding-right: 190px;">
