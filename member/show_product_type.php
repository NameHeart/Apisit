...
$query_product_type = "SELECT * FROM koi_product as p
INNER JOIN koi_type as t
ON p.type_id = t.type_id
WHERE p.type_id = $type_id
ORDER BY p.product_id ASC";
$result_product =mysqli_query($con, $query_product_type) or die ("Error in query: $query_product_type " . mysqli_error($con));
